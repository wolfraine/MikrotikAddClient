    ...
    public partial class MikrotikAddClient : Form
    {
        ...
        private void print_btn_Click(object sender, EventArgs e)
        {
            ...
            clientInfoPrint.Text = "/queue simple\n" +
                "add burst-limit=" + ((int)(UploadSpeed * 1.1)) + "M/" + DownloadSpeed * 1.1 + "M burst-threshold=" + UploadSpeed + "M/" + DownloadSpeed + "M burst-time=8s/8s max-limit=" + UploadSpeed + "M/" + DownloadSpeed + "M name=" + clientDescription + " queue=wireless-default/wireless-default target=" + ipAddress +
